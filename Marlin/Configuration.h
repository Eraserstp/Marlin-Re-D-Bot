...
#define CUSTOM_MACHINE_NAME "Re-D-Bot Mk2"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 79.00
  #define DEFAULT_bedKi 7.48
  #define DEFAULT_bedKd 208.70
 ...
 */
#define STEPS_KOEF 16 // 16 for A4988, 32 for DRV8825
#define HOBB_DIAMETER 7.3  //Diameter of hobb in mm
#define GEAR_RATIO 3 //Reductor ratio
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 6.25*STEPS_KOEF, 6.25*STEPS_KOEF, 31.25*STEPS_KOEF/1.25, (200*STEPS_KOEF*GEAR_RATIO)/(HOBB_DIAMETER*PI) }
...
#define X_MIN_POS -10  //Минус потому что стекло не доходит до края
#define Y_MIN_POS -5  //потому что клипсы стекла мешают
#define Z_MIN_POS 0
